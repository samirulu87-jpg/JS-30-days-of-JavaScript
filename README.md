Goals for what is included in this rep, 
-Two JavaScript programs from previous material in the HTML and CSS portions
-You will understand more about how to use functions, objects, arrays, and data types
